package tk.andrielson.carrinhos.androidapp.textinputmoeda;
...
public class CurrencyTextInputEditText extends TextInputEditText {
    ...
    PUBLIC METHODS
     */
    public CurrencyTextInputEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    ...
    private void processAttributes(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CurrencyTextInputEditText);
        this.hintCache = getHintString();
        updateHint();

        this.setAllowNegativeValues(array.getBoolean(R.styleable.CurrencyTextInputEditText_allow_negative_values, false));
        this.setDecimalDigits(array.getInteger(R.styleable.CurrencyTextInputEditText_decimal_digits, decimalDigits));
